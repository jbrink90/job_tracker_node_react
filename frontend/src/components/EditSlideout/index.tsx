      ...
      .then((data: LinkedInJobResponse) => {
        ...
        if (data.details) {
          switch (data.details) {
            ...
            default:
              enqueueSnackbar(
                "Failed to import from LinkedIn. Please check the URL and try again.",
                { variant: "error" },
              );
              break;
          }
      ...
      <>
        ...
        >
          ...
          >
            ...
            >
              Enter a LinkedIn job posting URL to automatically import job
              details
            </Typography>
            ...
            <Box sx={{ position: "relative" }}>
              ...
              <Button
                ...
                disabled={
                  !linkedinUrl ||
                  !linkedinUrl.includes("linkedin.com/jobs/view/") ||
                  loadingLinkedIn
                }
